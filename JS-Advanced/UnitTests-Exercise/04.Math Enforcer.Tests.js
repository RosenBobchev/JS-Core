...
describe('mathEnforcer', function () {
    describe('addFive', function () {
        it('addFive should work correctly if integer is passed', function () {
            let num = 5;
        ...
        it('addFive should work correctly if float is passed', function () {
            let num = 5.1;
        ...
        it('addFive should work correctly if negative float is passed', function () {
            let num = -5.1;
        ...
        it('if passed parameter is not a number return undefined',function () {
    ...
    describe('subtractTen',function () {
        ...
        it('subtractTen should work correctly if negative float is passed', function () {
            let num = -5.1;
        ...
        it('subtractTen should work correctly if float is passed', function () {
            let num = 10.1;
    ...
    describe('sum',function () {
        ...
        it('if one of the passed parameters is not a number return undefined',function () {
